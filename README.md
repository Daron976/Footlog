...
# 📖 Footlog <a name="about-project"></a>

This is a blog website that allows users to make comments about their football opinions
...
Feel free to check the [issues page](https://github.com/Daron976/Footlog/issues). 
